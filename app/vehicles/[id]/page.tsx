          ...
          <dl className="mt-6 grid grid-cols-2 gap-x-6 gap-y-3 text-sm">
            ...
            <div>
              ...
              <dd className="font-medium text-vivo-black">
                {listing.mileageKm ? `${listing.mileageKm.toLocaleString()} km` : 'n/a'}
              </dd>
            </div>
            <div>
              <dt className="text-vivo-black/40">Transmission</dt>
              <dd className="font-medium text-vivo-black">{listing.transmission ?? 'n/a'}</dd>
            </div>
            <div>
              <dt className="text-vivo-black/40">Fuel type</dt>
              <dd className="font-medium text-vivo-black">{listing.fuelType ?? 'n/a'}</dd>
            </div>
            <div>
          ...
          <div className="glass-card p-6">
            ...
            <form
              action={async (formData) => {
                'use server';
                await toggleVehicleListingActive(formData);
              }}
            >
