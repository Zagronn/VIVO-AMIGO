  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-4 max-w-2xl text-lg text-vivo-black/70">
        VIVO AMIGO started as a single marketplace and grew into a family of connected products —
      ...
      <div className="mt-12 space-y-6 text-vivo-black/70">
        <div>
          ...
          <p className="mt-2">
            Beyond the core marketplace, VIVO AMIGO now covers classifieds for real estate,
